...
caminho="${HOME}/Vídeos/screencast"
data=$(date +%Y-%m-%d_%H-%M-%S)
icone="/home/henrique/.icons/Arc/devices/24@2x/video-display.png"
...
then
	killall ffmpeg
	notify-send -i $icone "ScreenCast" " <b>$arquivo</b> foi terminado."
    exit 0
else
    notify-send -i $icone "ScreenCast" "<b>$arquivo</b> foi iniciado..."
